/*
 * The primary script to get your skeletons running inside of Unity.
 */
...
public struct ErrorReport
{
    ...
    public ErrorReport(string rigId, int err, string msg)
    {
        character = rigId;
        errorCode = err;
        message = msg;
...
public struct BoundsReport
{
    ...
    public BoundsReport(string rigId, string inType, int begin, int end, int frames)
    {
        character = rigId;
        type = inType;
        beginTime = begin;
...
public struct FrameReport
{
    ...
    public double[] boneLengths;
    public Position[] boneOffsets;
    //public double unitMeters;

    public FrameReport(string charName, int time, Position inPosition, Rotation[] inRotations, double[] lengths, Position[] offsets)
    {
        character = charName;
        timestamp = time;
        position = inPosition;
...
namespace Riggingtools.Skeletons
{
    ...
    {
        [Tooltip("The header data from the json file.\nGlobal End Frame\nGlobal FPS\nGlobal Start Frame")]
        [SerializeField]
        private HeaderData headerData = new HeaderData();
        [Tooltip("Each players information.\nID\nType\nStart Frame\nEnd Frame")]
        [SerializeField]
        private RigsData rigsData = new RigsData();

        [Tooltip("The original global frame from the rendering system.")]
        [SerializeField]
        private int originalFrame = 0;
        [Tooltip("The current local unity frame.")]
        [SerializeField]
        private int CurrentFrame = 0;
        [Tooltip("The total frames available for the current skeleton file.")]
        [SerializeField]
        ...
        public static bool isPlayersInstantiated = false;
        ...
        [Tooltip("Player Canvas Scripts attached to each player. This enables you to show/hide player ID's above their heads.")]
        [SerializeField]
